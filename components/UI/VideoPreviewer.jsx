    ...
    return (
        <div
            ...
            className={`${customClass} ${styles.videoBox
                } bg-video-previewer-props flex flex-wrap content-center overflow-hidden ${isClicked ? "items-center justify-start" : "justify-center"
        ...
        >
            ...
            {!isClicked ? (
                <div
                    className={`flexJustifyCenterWrap gap-4 px-3 xs:pt-5 lg:pt-7 ${isClicked ? styles.videoPlayerIn : styles.videoPlayerOut
                        }`}
                >
