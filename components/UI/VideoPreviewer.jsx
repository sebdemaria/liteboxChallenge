            ...
            <>
                <div
                    ...
                    className={`${customClass} ${styles.videoBox
                        } relative z-10 bg-video-previewer-props flex flex-wrap content-center overflow-hidden ${isClicked ? "items-center justify-start" : "justify-center"
                ...
                >
                    ...
                    {
                        deleteAvailable &&
                        <button className="z-30 absolute cursor-pointer w-3 top-3 left-3" onClick={handleDelete}>
                            <Image src={MenuBtnClose} data-title={title} alt="play button" />
                        </button>
                    }
                    ...
                    {!isClicked
                        ? (
                            <div
                                className={`flexJustifyCenterWrap w-full h-full  gap-1 px-3 xs:pt-7 ${isClicked ? styles.videoPlayerIn : styles.videoPlayerOut}`}
                            >
                                <Image src={PlayBtn} role="button" alt="remove movie button" width={'auto'} height={'auto'} />
                                <h2
                            ...
                            <div
                                className={`relative flex h-full w-full flex-wrap items-center bg-liteflixGray-transparent px-5 py-7 text-center font-oswald font-extralight uppercase tracking-superWide text-white-normal xs:text-[0.8rem] ${isClicked ? styles.videoPlayerIn : styles.videoPlayerOut
                                    }`}
                            >
